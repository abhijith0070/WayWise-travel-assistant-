...
function TripResultsContent() {
  ...
  const generateTripPlan = async (tripPrompt: string) => {
    try {
      ...
      // Handle plain text response from Ollama
      if (data.plan && typeof data.plan === 'string') {
        // Convert plain text to basic TripPlan structure
        const basicPlan: TripPlan = {
          destination: "Your Destination",
          from: "Your Location",
          title: "AI-Generated Trip Plan",
          description: "Powered by Ollama (Local AI)",
          duration: "As specified",
          budget: "Flexible",
          estimatedBudget: "See details below",
          bestFor: "All travelers",
          season: "Year-round",
          bestTimeToVisit: "Any time",
          overview: "This trip plan was generated using Ollama local AI",
          itinerary: [{
            day: 1,
            ...
            activities: [],
            meals: {
              breakfast: "See itinerary",
              lunch: "See itinerary",
              dinner: "See itinerary"
            },
            accommodation: "See itinerary details"
          }],
          transportation: {
            toDestination: "As per your preference",
            local: "As recommended in plan"
          },
          budgetBreakdown: {
            transport: "TBD",
            accommodation: "TBD",
            ...
            activities: "TBD",
            miscellaneous: "TBD",
            total: "See plan details"
          },
          packingList: [],
          localTips: ["Trip plan generated using Ollama local AI"],
          tips: ["Refresh to generate a new plan", "Make sure Ollama is running locally"],
          mustTryFoods: [],
          mustVisitPlaces: [],
          source: "ollama-llama2"
        }
        setTripPlan(basicPlan)
      } else if (data.tripPlan) {
