...
export async function POST(request: NextRequest) {
  try {
    ...
    let url = `https://maps.googleapis.com/maps/api/directions/json?origin=${encodeURIComponent(from.trim())}&destination=${encodeURIComponent(to.trim())}&mode=${googleMode}&key=${apiKey}`;
